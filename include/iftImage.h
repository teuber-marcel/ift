 ...
 * @date Mar 26, 2018
 */
typedef void (*iftCopyImageVoxelFunc)(   iftImage *src, iftVoxel u, iftImage *dst, iftVoxel v);
...
//! swig()
static inline bool iftIs3DImage(   iftImage *img) {
    return (img->zsize > 1);
}
 ...
 * @param P Point.
 */
static inline bool iftValidPoint(   iftImage *img, iftPoint P) {
 ...
 */
void iftWriteImageNIfTI(   iftImage *img, const char *filename, ...);
 ...
 * @date Jul 18, 2017
 */
void iftWriteImageAnalyze(   iftImage *img, const char *filename, ...);
 ...
 * @ingroup Image
 */
void iftWriteImageGZip(   iftImage *img, const char *filename, ...);
 ...
 */
void iftCopyImageInplace(   iftImage *src, iftImage *dst);
...
static inline iftColor iftGetYCbCr(   iftImage *img, int p) {
    iftColor YCbCr;
 ...
 * @warning The Size of the ROI Image is the the same of the Input Bounding
 */
iftImage *iftExtractObjectInsideROI(   iftImage *src_img, iftBoundingBox bb, int obj_label);
