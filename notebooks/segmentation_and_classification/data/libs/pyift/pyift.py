...
def CuboidWithDilationForConv(xsize: "int", ysize: "int", zsize: "int", sx: "int", sy: "int", sz: "int") -> "iftAdjRel *":
    r"""
...
def RectangularWithDilationForConv(xsize: "int", ysize: "int", sx: "int", sy: "int") -> "iftAdjRel *":
    r"""
...
def MinimumValue(img: "Image") -> "int":
    r"""
...
def ImageRed(img: "Image") -> "iftImage *":
    r"""
    ImageRed(img) -> Image
...
def ImageGreen(img: "Image") -> "iftImage *":
    r"""
...
def ImageBlue(img: "Image") -> "iftImage *":
    r"""
    ImageBlue(img) -> Image
...
def ReadRawMatrix(filename: "char *") -> "iftMatrix *":
    r"""
...
def ExtendMImageByMImage(mimg1: "MImage", mimg2: "MImage") -> "iftMImage *":
    r"""
...
def GaussianMKernel2D(radius: "float", stdev: "float", nbands: "int") -> "iftMKernel *":
    r"""
...
def FMedianFilter(fimg: "FImage", Ain: "AdjRel") -> "iftFImage *":
    r"""
...
def RobotFindSeedsCenterOfMass3D(bot: "Robot") -> "void":
    r"""
...
def RobotFindSeedsEDT3D(bot: "Robot") -> "void":
    r"""
...
def FLIMAdaptiveAdjRelFromKernel(layer: "iftFLIMLayer", atrous_factor: "int", dim3D: "bool") -> "iftAdjRel *":
    r"""
    FLIMAdaptiveAdjRelFromKernel(layer, atrous_factor, dim3D) -> AdjRel
    ...
    """
    return _pyift.FLIMAdaptiveAdjRelFromKernel(layer, atrous_factor, dim3D)
...
def DynTreeRootCostMap(mimg: "MImage", A: "AdjRel", seeds: "LabeledSet") -> "iftFImage *":
    r"""
