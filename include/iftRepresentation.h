...
/**
 * @brief Computes a 2D colored multiscale skeleton over its binary image. 
 *
 * @author Alexandre Falcao
 * @date   February 2024
 *
 * @param bin: its binary image
 * @return the colored multiscale skeleton over its binary image 
*/
...
/**
 * @brief Computes the integral image of a given input image
 * @author Alexandre Falcao
 * @date   February 10th, 2024
 * @param  input image 
 * @return The resulting integral image
 *
 */
//! swig(newobject, stable)
...
/**
 * @brief Given an integral image, region size Wx x Wy x Wz and
 * displacements (Dx,Dy,Dz), it returns the cummulative-value
 * image. The cummulative values of the original image used to create
 * the integral image are computed inside a region Wx x Wy x Wz of the
 * integral image around a voxel v obtained with displacement
 * (Dx,Dy,Dz) from each voxel u of the image domain. Haar-like
 * features may be obtained from mathematical operations on multiple
 * cummulative-value images.
 * @author Alexandre Falcao
 * @date   February, 10th 2024
 * @param  an integral image
 * @param  displacement Dx
 * @param  displacement Dy
 * @param  displacement Dz
 * @param  region size Wx
 * @param  region size Wy
 * @param  region size Wz.
 * @return The cummulative-value image. 
 *
 */
//! swig(newobject, stable)
...
/**
 * @brief  Extract the set of branch points of a binary skeleton.
 * @author Alexandre Falcao
 * @date   February 2024
 * @param  Binary skeleton.
 * @return Set of branch points of the input skeleton.
 *
 */
//! swig(newobject, stable)
