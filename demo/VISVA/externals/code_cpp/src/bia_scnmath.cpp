...
namespace bia{
  ...
  namespace Scene{
	...
	bia::Error((char *)"Incompatible number of bits",
		   (char *)"Scene::Sub");

      diff = (Scene *) calloc(1,sizeof(Scene));
      if(diff == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::Sub");
	...
	bia::Error((char *)"Incompatible number of bits",
      ...
      if(sum == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::Add");
	...
	bia::Error((char *)"Incompatible number of bits",
      ...
      if(mscn == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::Mult");
	...
	bia::Error((char *)"Incompatible number of bits",
      ...
      if(scnor == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::Or");
	...
	bia::Error((char *)"Incompatible number of bits",
      ...
      if(scnand == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::And");
	...
	bia::Error((char *)"Incompatible number of bits",
      ...
      if(scnxor == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::XOr");
    ...
    Scene *Complement(Scene *scn){
      ...
      if(cscn == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::Complement");
