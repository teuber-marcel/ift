...
namespace OIFT{
  ...
  LiveHandlerOIFT :: LiveHandlerOIFT(char axis,
			     ModuleOIFT *mod){
    this->axis = axis;
    this->mod = mod;
    this->frontier = NULL;
  ...
  LiveHandlerOIFT :: ~LiveHandlerOIFT(){
  ...
  void LiveHandlerOIFT :: OnRightClick(int p){
    int *boundary=NULL;
    Voxel u;
    Pixel a;
    int pxl;
  ...
  void LiveHandlerOIFT :: OnMiddleClick(int p){
    Voxel u;
    Pixel a;
  ...
  void LiveHandlerOIFT :: OnMouseWheel(int p, int rotation, int delta){
  }


  void LiveHandlerOIFT :: OnLeftDrag(int p, int q){
  }

  void LiveHandlerOIFT :: OnRightDrag(int p, int q){
  }

  void LiveHandlerOIFT :: OnMouseMotion(int p){
    Voxel u;
    Pixel a;
    int *boundary=NULL;
    int pxl;
  ...
  int *LiveHandlerOIFT :: LiveWire(int px,
			       bool add_click, 
			       bool close_click, 
			       bool del_click){
    int *boundary=NULL;
  ...
  Pixel LiveHandlerOIFT :: GetCorrespondingPixel(int p_scn){
    Voxel u;
    Pixel a;
  ...
  Voxel LiveHandlerOIFT :: GetCorrespondingVoxel(int p_img){
    Voxel u;
    Pixel a;
  ...
  Image *LiveHandlerOIFT :: GetZSlice(Scene *scn, int z){
    Image *img=NULL;
    int n;
    int *data;
  ...
  Image *LiveHandlerOIFT :: GetXSlice(Scene *scn, int x){
    Image *img=NULL;
    int i,j;
    Voxel v;
  ...
  Image *LiveHandlerOIFT :: GetYSlice(Scene *scn, int y){
    Image *img=NULL;
    int i,j;
    Voxel v;
  ...
  void LiveHandlerOIFT :: RefreshPath(int *boundary){
    Voxel v;
    int i,n,q;
  ...
  void LiveHandlerOIFT :: InsertPathSeeds(int *cpath){
    Image *tmp=NULL;
    Pixel a,b,c;
    Voxel u;
  ...
  bool LiveHandlerOIFT :: IsAnchorPoint(int px){
    int i;
    for(i=0; i<npoints; i++)
  ...
  int LiveHandlerOIFT :: GetLastAnchorPoint(){
    if(npoints>0)
  ...
  int LiveHandlerOIFT :: GetFirstAnchorPoint(){
    if(npoints>0)
  ...
  void LiveHandlerOIFT :: AppendAnchorPoint(int px){
    anchorpoints[npoints] = px;
    npoints++;
  }

  void LiveHandlerOIFT :: DelLastAnchorPoint(){
    if(npoints>0)
      npoints--;
  }

  void LiveHandlerOIFT :: ClearAnchorPoints(){
    npoints = 0;
  }
