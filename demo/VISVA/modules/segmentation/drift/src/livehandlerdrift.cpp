...
namespace DRIFT{
  ...
  LiveHandlerDRIFT :: LiveHandlerDRIFT(char axis,
			     ModuleDRIFT *mod){
    this->axis = axis;
    this->mod = mod;
    this->frontier = NULL;
  ...
  LiveHandlerDRIFT :: ~LiveHandlerDRIFT(){
  ...
  void LiveHandlerDRIFT :: OnRightClick(int p){
    int *boundary=NULL;
    Voxel u;
    Pixel a;
    int pxl;
  ...
  void LiveHandlerDRIFT :: OnMiddleClick(int p){
    Voxel u;
    Pixel a;
  ...
  void LiveHandlerDRIFT :: OnMouseWheel(int p, int rotation, int delta){
  }


  void LiveHandlerDRIFT :: OnLeftDrag(int p, int q){
  }

  void LiveHandlerDRIFT :: OnRightDrag(int p, int q){
  }

  void LiveHandlerDRIFT :: OnMouseMotion(int p){
    Voxel u;
    Pixel a;
    int *boundary=NULL;
    int pxl;
  ...
  int *LiveHandlerDRIFT :: LiveWire(int px, 
			       bool add_click, 
			       bool close_click, 
			       bool del_click){
    int *boundary=NULL;
  ...
  Pixel LiveHandlerDRIFT :: GetCorrespondingPixel(int p_scn){
    Voxel u;
    Pixel a;
  ...
  Voxel LiveHandlerDRIFT :: GetCorrespondingVoxel(int p_img){
    Voxel u;
    Pixel a;
  ...
  Image *LiveHandlerDRIFT :: GetZSlice(Scene *scn, int z){
    Image *img=NULL;
    int n;
    int *data;
  ...
  Image *LiveHandlerDRIFT :: GetXSlice(Scene *scn, int x){
    Image *img=NULL;
    int i,j;
    Voxel v;
  ...
  Image *LiveHandlerDRIFT :: GetYSlice(Scene *scn, int y){
    Image *img=NULL;
    int i,j;
    Voxel v;
  ...
  void LiveHandlerDRIFT :: RefreshPath(int *boundary){
    Voxel v;
    int i,n,q;
  ...
  void LiveHandlerDRIFT :: InsertPathSeeds(int *cpath){
    Image *tmp=NULL;
    Pixel a,b,c;
    Voxel u;
  ...
  bool LiveHandlerDRIFT :: IsAnchorPoint(int px){
    int i;
    for(i=0; i<npoints; i++)
  ...
  int LiveHandlerDRIFT :: GetLastAnchorPoint(){
    if(npoints>0)
  ...
  int LiveHandlerDRIFT :: GetFirstAnchorPoint(){
    if(npoints>0)
  ...
  void LiveHandlerDRIFT :: AppendAnchorPoint(int px){
    anchorpoints[npoints] = px;
    npoints++;
  }

  void LiveHandlerDRIFT :: DelLastAnchorPoint(){
    if(npoints>0)
      npoints--;
  }

  void LiveHandlerDRIFT :: ClearAnchorPoints(){
    npoints = 0;
  }
