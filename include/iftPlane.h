 ...
 * @date Nov 22, 2018
 */
void iftWritePlane(   iftPlane *pl, const char *pathname, ...);
 ...
 * @date Nov 25, 2018
 */
inline iftPlane *iftCopyPlane(   iftPlane *pl) {
    if (pl) {
 ...
 * @date Nov 22, 2018
 */
inline iftPlane *iftScalePlane(   iftPlane *pl, float scaling_factor) {
 ...
 * @date Nov 21, 2018
 */
float iftGetBiasFromPlane(   iftPlane *pl);
 ...
 * @date Nov 22, 2018
 */
iftPoint iftGetPointFromYZPlaneProjection(   iftPlane *pl, float y, float z);
