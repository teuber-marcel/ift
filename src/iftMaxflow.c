...
iftMaxflowGraph* iftMaxflowGraphFromGradient(  iftImage* gradient, iftLabeledSet* seeds, int beta){
...
iftMaxflowGraph* iftMaxflowGraphFromMImage(  iftMImage* mimg, iftLabeledSet* seeds, int beta){
...
iftMaxflowGraph* iftMaxflowGraphFromMImageProb(  iftMImage* mimg,   iftImage *regions,   iftFImage *obj_prob,
                                                 iftFImage *bkg_prob, double beta)
{
    int n_edges = 0;
      int gamma = 50; /* fixed by grabcut paper */
    iftAdjRel *A = NULL;
...
iftMaxflowGraph* iftMaxflowGraphWithObjmap(  iftMImage* mimg,   iftImage *objmap,
...
iftImage *iftMMaxflowSegment(iftMaxflowGraph *graph,   iftMImage *mimg)
{
...
iftImage *iftMaxflowSegment(iftMaxflowGraph *graph,   iftImage *img)
{
...
float iftOptimumPathMaxflow(iftMaxflowGraph *graph,   iftImage* gradient) {
