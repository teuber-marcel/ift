...
#define REAL_MIN -FLT_MAX //-DBL_MAX
...
void UChange(uint *a, uint *b); /* It changes content between a and b */

void ULChange(unsigned long long *a, unsigned long long *b); /* It changes content between a and b */
...
http://www.ime.usp.br/~pf/algoritmos/aulas/random.html
   Call RandomSeed before, to initialize seed for rand()
 **/
int  RandomInteger (int low, int high);
void RandomSeed();

__inline__ real sqrtreal(real x);
