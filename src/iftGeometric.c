...
iftImage *iftTransformImageByMatrix(  iftImage *img,   iftMatrix *M) {
    if (img == NULL)
...
iftImage *iftFlipImage(  iftImage *img, iftAxis axis) {
...
iftMImage *iftFlipMImage(  iftMImage *mimg, iftAxis axis) {
