 ...
 * @date Mar 13, 2017
 */
iftImage *iftN4BiasFieldCorrection(   iftImage *img,    iftImage *mask, int shrink_factor,
                                   iftImage **out_bias);
 ...
 * @date Mar 13, 2017
 */
iftImage *iftEffectiveN4BiasFieldCorrection(   iftImage *img,    iftImage *mask, iftImage **out_bias);
