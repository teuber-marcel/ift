...
/**
 * @brief F1-Score for binary segmentation.\n Given a groundtruth and binary image, compute the F1-Score.\n
 * @author
 * @date
 * @ingroup Segmentation
 *
...
/**
* @brief Computes Intersection over Union for Object Detection
* @author Felipe Crispim
* @date January 09, 2023
* @ingroup Segmentation
*
* @param gt_bb - Ground truth bounding box
* @param pred_bb - Predicted bounding box
* @return Intersection over Union [0, 1]
*/
...
/// @brief Based on paper Relaxed Image Foresting Transforms for Interactive Volume Image Segmentation
///        of Malmberg et. al., 2010 AND Graph-Based Image Segmentation Using Dynamic Trees of Bragantini
///        et. al., 2019. DOI: 10.1117/12.840019 (Relaxed IFT), DOI: 10.1007/978-3-030-13469-3_55 (Dynamic Trees)
/// @author Marcelo Rodrigues
/// @data May 20th 2025
/// @param mimg - multichannel image 
/// @param saliency - original adaptive decoder outputs data in 8-bit format. Here, it is represented by an object confidence map used to seed computation, and its values will be propagated within the Dynamic Trees algorithm
/// @param border_dist - if 1 components near borders will be removed 
/// @param min_obj_area - Minimum binary area threshold for filtering components
/// @param max_obj_area - Maximum binary area threshold for filtering components
/// @param seed_erosion - erosion factor to estimate Dynamic Trees seeds 
/// @param seed_dilation - dilation factor to estimate Dynamic Trees seeds 
/// @param relaxation_iterations - total of iterations in relaxation procedure
/// @param alpha_confidence - alpha factor controls the fusion of the label map with the propagated saliency map generetated by Dynamic Trees. A high alpha value means placing more confidence in the saliency values propagated by the adaptive decoder.
/// @return The Saliency Map results from the fusion of the label map and propagated saliency values
//! swig(newobject)
