...
FEAT_EXTRACTION_SCRIPT_PATH = "$NEWIFT_DIR/demo/BrainAnomalyDetection/AttentionMap/extract_svoxel_vlbp_feats.py"
...
def main():
    ...
    if not args.skip_feat_extraction:
        ...
        print("\n\n####### Feature Extraction")
        feat_extract_cmd_args = f"--image {reg_error_path} --supervoxels {svoxels_path} " \
                                f"--training-set {args.training_reg_error_set} " \
