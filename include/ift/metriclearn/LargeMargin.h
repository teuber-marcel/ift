...
static inline void iftUpdateMatrixE(double *E,    double *diff, int n, int i, int j)
{
    int ii = i * n;
    int jj = j * n;
    for (int k = 0; k < n; k++) {
...
static inline void iftDiffKiKj(   double *gram, double *diff, int n, int i, int j, double c)
{
    int ii = i * n;
    int jj = j * n;
    for (int k = 0; k < n; k++) {
