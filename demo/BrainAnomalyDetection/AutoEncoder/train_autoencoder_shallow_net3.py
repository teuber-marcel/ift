...
def train_autoencoder(Xsource, Xtarget, epochs=500, batch_size=1):
    ...
    x = Conv3D(64, kernel_size=3, activation='relu', padding='same')(input_img)
    ...
    x = Conv3D(32, kernel_size=3, activation='relu', padding='same')(encoded)
...
def main():
    ...
    X = util.adjust_image_domain(X, max_pooling_sizes=[2, 2])
