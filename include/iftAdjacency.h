...
void iftWriteAdjRelBinFile(   iftAdjRel *A, const char *path);
 ...
 * @date Apr 27, 2018
 */
iftAdjRel *iftAdjacencyBoundaries(   iftAdjRel *A,    iftAdjRel *B);
...
void iftSidePixels(   iftVoxel *u,    iftVoxel *v, float radii, iftVoxel *left, iftVoxel *right);

void iftSidePixelsWithJitter(   iftVoxel *u,    iftVoxel *v, float radii,
                             int mod, iftVoxel *left, iftVoxel *right);


/**
 * @brief Create an adjacency relation with a cuboid shape and atrous dilation.
 * @author  Alexandre Falcao.
 * @date    Nov, 2022.
 * @ingroup Description
 *
 * @param xsize, ysize, zsize: cuboid's sizes. 
 * @param sx, sy, sz: atrous dilation factors per axis. 
...
/**
 * @brief Create an adjacency relation with a cuboid shape and atrous
 * dilation, by preserving the central element in its original
 * position. That is, by not following the default of libift, which is
 * to shift the central element to the first position of the adjacency
 * relation.  
 * @author  Alexandre Falcao.
 * @date    Nov, 2022.
 * @ingroup Description
 ...
 */
//! swig()
  iftAdjRel *iftCuboidWithDilationForConv(int xsize, int ysize, int zsize, int sx, int sy, int sz);

/**
 * @brief Create an adjacency relation with a rectangular shape and atrous dilation.
 * @author  Alexandre Falcao.
 * @date    Nov, 2022.
 * @ingroup Description
 *
 * @param xsize, ysize: rectangle's sizes. 
 * @param sx, sy: atrous dilation factors per axis. 
 * @return adjacency relation
 */
//! swig()
  iftAdjRel *iftRectangularWithDilation(int xsize, int ysize, int sx, int sy);
...
/**
 * @brief Create an adjacency relation with a rectangular shape and atrous
 * dilation, by preserving the central element in its original
 * position. That is, by not following the default of libift, which is
 * to shift the central element to the first position of the adjacency
 * relation.  
 ...
 * @ingroup Description
 *
 * @param xsize, ysize: retangle's sizes. 
 * @param sx, sy: atrous dilation factors per axis. 
 * @return adjacency relation
 */
//! swig()
  iftAdjRel *iftRectangularWithDilationForConv(int xsize, int ysize, int sx, int sy);
