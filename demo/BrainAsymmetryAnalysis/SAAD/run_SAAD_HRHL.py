...
os.system(f"make iftExtractSupervoxelHRHLFeats -C $NEWIFT_DIR/demo/BrainAsymmetryAnalysis/SAAD")
...
def main():
    ...
    if not args.skip_feat_extraction:
        ...
        print("\n\n####### Feature Extraction")
        feat_extraction_cmd = f"iftExtractSupervoxelHRHLFeats --test-image {args.image_path} "\
