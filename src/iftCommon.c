...
iftIntArray *iftIntArrayUnique(  int *array, int n) {
    if (array == NULL)
...
int iftCountUniqueIntElems(  int *array, int n) {
...
bool iftIntArrayContainValue(  int *array, int n, int value) {
...
int iftMedianIntVal(  iftIntArray *arr) {
...
/* returns abs(gamma(x+iy)/gamma(x))^2 */
      double y2=y*y, xmin = (2*y2>10.0) ? 2*y2 : 10.0;
...
int iftMaxValIntArray(  int *array, int n,   int *mask)
{
...
int iftMinValIntArray(  int *array, int n,   int *mask)
{
