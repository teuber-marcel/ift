 ...
 * @date Dec 12, 2018
 */
typedef iftImage* (*iftImageSubFunc)(   iftImage *img1,    iftImage *img2);
 ...
 * @date Jan 16, 2017
 */
void iftAddInPlace(   iftImage *src,    iftImage *dst);
 ...
 * @date Nov 16, 2017
 */
iftImage *iftAddScalar(   iftImage *src, int scalar);
 ...
 * @date Dec 26, 2017
 */
iftFImage *iftMultByFImage(   iftImage *img,    iftFImage *fimg);
 ...
 * @date Nov 30, 2017
 */
iftFImage *iftMultByScalar(   iftImage *img, float scalar);
 ...
 * @date Aug 27, 2018
 */
iftImage *iftSquareSub(   iftImage *img1,    iftImage *img2);
...
/** @brief Gets the Complement to an upper bound (only the Y channel)
    from an Image.*/
//! swig(newobject, stable))
  iftImage *iftComplementToAnUpperBound(iftImage *img, int maxval);
 ...
 * @date Jan 24, 2019
 */
iftImage *iftObjectMask(   iftImage *img,    iftImage *mask, int label);
...
iftImage *iftBinaryFrom255To1(   iftImage *bin);
...
iftFImage *iftFSQRT(   iftFImage *img);
 ...
 */
iftImage *iftImageLinearCombination(   iftImage *img0,    iftImage *img1, double alpha);
 ...
 */
int iftModeValue(   iftImage *img, iftImage *mask);
 ...
 * @date Sep 4, 2018
 */
iftFloatArray *iftMeanValueInRegions(   iftImage *img,    iftImage *label_img);
 ...
 * @date Sep 4, 2018
 */
iftMatrix *iftMeanStdevValuesInRegions(   iftImage *img,    iftImage *label_img, float norm_val);
