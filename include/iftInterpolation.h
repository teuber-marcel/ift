 ...
 * @date Nov 25, 2018
 */
typedef int (*iftInterpPointFunc)(   iftImage *img, iftPoint P);
...
iftImage *iftResliceImageSimple(   iftImage *img, int dx, int dy, int dz, iftAxisOrder axis_order);
 ...
 * @date Apr 22, 2018
 */
iftImage *iftResliceImageByTransMatrix(   iftImage *img, iftMatrix *R);
