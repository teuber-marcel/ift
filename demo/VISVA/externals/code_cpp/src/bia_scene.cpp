...
namespace bia{
  namespace Scene{
    ...
    Scene *Create(int xsize,int ysize,int zsize, int nbits, bia_SceneType type){
      ...
      if(scn == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::Create");
    ...
    Scene *Clone(Scene *scn){
      ...
      if(aux == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::Clone");
    ...
    Scene *SubScene(Scene *scn,
      ...
      aux = (Scene *) calloc(1,sizeof(Scene));
      if(aux == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::SubScene");
  ...
  // Parei aqui.
    ...
    Scene *MBB(Scene *scn){
      ...
      aux = (Scene *) calloc(1,sizeof(Scene));
      if(aux == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::MBB");
    ...
    Scene *AddFrame(Scene *scn,  int sz, int value){
      ...
      aux = (Scene *) calloc(1,sizeof(Scene));
      if(aux == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::AddFrame");
    ...
    Scene *RemFrame(Scene *fscn, int sz){
      ...
      aux = (Scene *) calloc(1,sizeof(Scene));
      if(aux == NULL) 
	bia::Error((char *)MSG1,(char *)"Scene::RemFrame");
