 ...
 * @date Sep 1, 2018
 */
iftMImage *_iftBuildBrainHemisphereMImageOISF(  iftImage *img,   iftImage *asym_map) {
...
iftImage *iftBrainDiffMap(  iftImage *img,   iftImage *template_img,   iftImage *bias) {
 ...
 * @date Dec 11, 2018
 */
void iftSupervoxelHAAFeatsInAsymMap(  iftImage *asym_map,   iftImage *svoxels_brain_side,
...
void iftSupervoxelBICFeatsInAsymMap(  iftImage *asym_map,   iftImage *svoxels_brain_side,
