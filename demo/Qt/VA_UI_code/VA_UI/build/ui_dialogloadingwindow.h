...
public:
    ...
    {
        DialogLoadingWindow->setWindowTitle(QApplication::translate("DialogLoadingWindow", "Dialog", 0));
        progressBar->setFormat(QApplication::translate("DialogLoadingWindow", "%v/%m", 0));
    } // retranslateUi
