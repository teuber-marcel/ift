...
iftFileSet *iftAtlasSelectionByNMI(  iftImage *test_img,   iftFileSet *train_img_set, int n_atlases,
                                     iftImage *test_mask,   iftFileSet *train_mask_set,
...
iftImage *iftSegmentByClassicalMALF(  iftImage *test_img,   iftFileSet *train_label_set) {
...
iftImage *iftSegmentByMALFSTAPLE(  iftImage *test_img,   iftFileSet *train_atlas_set) {
