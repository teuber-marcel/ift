...
void            iftCentralizePatch(  float *mean, iftMatrix *M);
...
{
  static   int MIN_OMP_SIZE = 5000000;
  iftNeuralLayer* layer = net->layers[l];
...
iftNeuralLayer* iftImageLayer(iftNeuralNetwork* net,   iftFileSet* fileset)
{
	iftNeuralLayer* layer = iftCreateNeuralLayer();
...
iftNeuralLayer* iftRawDataLayer(iftNeuralNetwork* net,   iftMatrix* X,   iftMatrix* Y) {
...
iftNeuralLayer* iftDataSetLayer(iftNeuralNetwork* net,   iftDataSet* Z) {
	iftNeuralLayer* layer = iftCreateNeuralLayer();
...
void iftFullyConnectedUpdate(iftNeuralNetwork* net, int l) {
	...
	iftNeuralLayer* layer = net->layers[l];
	  ...
	  double alpha = net->learnRate;
	//  double gamma = net->weightDecay;
	  double minibatch = net->miniBatch;
	  double decay = net->weightDecay;
...
iftConvNetwork* iftCreateConvNetworkFromDict(  iftDict* params) {
