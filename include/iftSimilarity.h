 ...
 * To do that, use the program demo/Miscellaneous/iftCheckLabelImages.c
 */
iftDblArray *iftDiceSimilarityMultiLabel(   iftImage *label_source,
                                            iftImage *label_target, int n_objects);
 ...
 * To do that, use the program demo/Miscellaneous/iftCheckLabelImages.c
 */
double iftASD(   iftImage *bin_source,    iftImage *bin_target);
 ...
 * To do that, use the program demo/Miscellaneous/iftCheckLabelImages.c
 */
iftDblArray *iftASDMultiLabel(   iftImage *label_source,    iftImage *label_target, int n_objects);
 ...
 * To do that, use the program demo/Miscellaneous/iftCheckLabelImages.c
 */
iftDblArray *iftASSDMultiLabel(   iftImage *label_source,    iftImage *label_target, int n_objects);
 ...
 * @ingroup ImageMetrics
 */
iftMatrix *iftComputeScoreMatrixByDice(   iftFileSet *label_img_files, int n_objs);
 ...
 * @ingroup ImageMetrics
 */
iftMatrix *iftComputeScoreMatrixByASSD(   iftFileSet *label_img_files, int n_objs);
 ...
 * @ingroup ImageMetrics
 */
double iftImageEuclideanDistance(   iftImage *img1,    iftImage *img2);
 ...
 * @ingroup ImageMetrics
 */
iftDblArray *iftImageEuclideanDistanceForLabels(   iftImage *img1,    iftImage *img2,
                                                   iftImage *label_img);
 ...
 * @ingroup ImageMetrics
 */
double iftASA(   iftImage* super_map,    iftImage* gt);
