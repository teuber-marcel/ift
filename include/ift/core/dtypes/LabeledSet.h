...
/**
 * @brief Reads a labeled set file with 2D or 3D seeds.  
 * 
 * @param filename name of the file
 * @param dim      2 or 3 dimensions
 *
 * @author Falcao
 * @date   Aug, 2023
 * @return The labeled set
 */
  
  iftLabeledSet *iftReadLabeledSet(char *filename, int dim);

/**
 * @brief Writes a labeled set file with 2D or 3D seeds.  
 * 
 * @param S is the labeled set
 * @param xsize, ysize, zsize defines the image domain
 * @param filename name of the file
 *
 * @author Falcao
 * @date   Aug, 2023
...
void iftPrintLabeledSet(iftLabeledSet *S, int xsize, int ysize, int zsize);
