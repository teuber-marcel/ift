...
public:
    ...
    virtual void renderGraphics(QImage *image, QGraphicsPixmapItem *imagePixmap, int sliceType);
...
protected:
    ...
    virtual void updateLabel(iftImage *label);
    virtual iftImage *generateLabel() = 0;
