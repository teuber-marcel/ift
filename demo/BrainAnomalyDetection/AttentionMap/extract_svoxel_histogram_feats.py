...
def build_argparse():
    prog_desc = \
'''
Extracts the histogram for each supervoxel from a given test attention map.
...
def main():
    ...
    Zarr = ift.ExtractSupervoxelAttentionMapFeats(attention_map, svoxels_img, train_set, args.bins, None)    
