 ...
 */
iftSlic *iftInitSlicGPU(   iftImage *grad,    iftMImage *mimg, int input_n_cells, double comp,
                     int img_max_range);
 ...
 *                    (if the YCbCr Image is colored) or the original Grayscale Image (1 band)
 */
// void iftUpdateCellCentersGPU(iftSlic *slic,    iftImage *superpixels,    iftMImage *mimg);
 ...
 */
iftImage *iftGenerateSuperpixelsBySlicGPU(   iftImage *img,    iftImage *input_grad, int input_n_cells,
 ...
 * @return                   The Superpixel Image.
 */
iftImage *iftGenerateSuperpixelsBySlicInBlocksGPU(   iftImage *img,    iftImage *input_grad, int n_blocks,
