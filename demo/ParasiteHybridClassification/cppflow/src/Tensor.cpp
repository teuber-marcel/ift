...
Tensor::Tensor(  Model& model,   std::string& operation) {
...
void  Tensor::error_check(bool condition,   std::string &error) {
    if (!condition) {
        this->flag = -1;
...
template<typename T> void Tensor::set_data(std::vector<T> new_data,   std::vector<int64_t>& new_shape) {
...
std::vector<T> Tensor::get_data() {
    ...
    // Convert to correct type
      auto T_data = static_cast<T*>(raw_data);
...
// VALID set_data TEMPLATES
template void Tensor::set_data<float>(std::vector<float> new_data,   std::vector<int64_t>& new_shape);
template void Tensor::set_data<double>(std::vector<double> new_data,   std::vector<int64_t>& new_shape);
//template void Tensor::set_data<bool>(std::vector<bool> new_data,   std::vector<int64_t>& new_shape);
template void Tensor::set_data<int8_t>(std::vector<int8_t> new_data,   std::vector<int64_t>& new_shape);
template void Tensor::set_data<int16_t>(std::vector<int16_t> new_data,   std::vector<int64_t>& new_shape);
template void Tensor::set_data<int32_t>(std::vector<int32_t> new_data,   std::vector<int64_t>& new_shape);
template void Tensor::set_data<int64_t>(std::vector<int64_t> new_data,   std::vector<int64_t>& new_shape);
template void Tensor::set_data<uint8_t>(std::vector<uint8_t> new_data,   std::vector<int64_t>& new_shape);
template void Tensor::set_data<uint16_t>(std::vector<uint16_t> new_data,   std::vector<int64_t>& new_shape);
template void Tensor::set_data<uint32_t>(std::vector<uint32_t> new_data,   std::vector<int64_t>& new_shape);
template void Tensor::set_data<uint64_t>(std::vector<uint64_t> new_data,   std::vector<int64_t>& new_shape);
