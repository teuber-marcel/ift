 ...
 * @date Nov 22, 2018
 */
_iftMSPSearchParams _iftGetMSPSearchParamsStage1(  iftImage *img) {
 ...
 * @date Nov 22, 2018
 */
_iftMSPSearchParams _iftGetMSPSearchParamsStage2(  iftImage *img, iftPlane *msp_new_scale,
 ...
 * @date Nov 22, 2018
 */
_iftMSPSearchParams _iftGetMSPSearchParamsStage3(  iftImage *img, iftPlane *msp_new_scale,
 ...
 * @date Nov 22, 2018
 */
float _iftSymmetricScoreBin(  iftImage *bin_mask,   iftIntArray *obj_voxels,   iftPlane *msp) {
 ...
 * @date Nov 22, 2018
 */
iftPlane *_iftFindMSP(  iftImage *img, _iftMSPSearchParams msp_params) {
