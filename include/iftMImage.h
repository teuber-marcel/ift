...
//! swig()
static inline bool iftIs3DMImage(   iftMImage *img) {
    return (img->zsize > 1);
}
...
iftMImage *iftReadMImageFromNumPy(const char *npy_path, ...);
  ...
  /**
 * @brief Read a batch of multichannel images into an array.
 * 
 * @param fs: File set with a list of image names.
 * @param first: number of the first image for the batch
 * @param last: number of the last image for the batch
 * @return Loaded multichannel image array
 * 
...
//! swig(newobject, stable)
  ...
  /**
 * @brief Write an array containing a batch of multichannel images 
 * 
 * @param batch: array containing multichannel images
 * @param fs: File set with a list of image names
 * @param first: number of the first image for the batch
 * @param last: number of the last image for the batch
 ...
 */
//! swig(stable)
void iftWriteMImageAsNumPy(   iftMImage *mimg, const char *npy_path, ...);
