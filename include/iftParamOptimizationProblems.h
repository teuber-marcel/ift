...
typedef struct ift_obj_model_mean_arc_weight {
       iftImage *grad_test_img;
    int label;
       iftLabeledSet *seeds;
       iftSet *certain_obj_region;
       iftSet *forbidden;
    iftVector max_disp;
 ...
 * @date Jan 2, 2017
 */
iftGradMatchProb *iftCreateGradMatchProb(   iftImage *fixed_grad_img,    iftImage *mov_grad_img, iftVector max_disp);
...
iftPatchLocalizationNMIProb *iftCreatePatchLocalizationNMIProb(   iftImage *test_img,
                                       iftImage *ref_img, iftBoundingBox true_ref_patch,
...
iftBoundingBox iftMSPSMaxPatchNMI(   iftImage *img,    iftImage *template_img, iftBoundingBox true_template_patch,
                                        iftBoundingBox patch, iftBoundingBox search_region);
 ...
 * @date Jan 2, 2017
 */
iftVector iftMSPSMatchGradients(   iftImage *fixed_grad_img,    iftImage *mov_grad_img, int n_scales, int stride, iftVector max_disp);



iftObjModelMeanArcWeight *iftCreateObjModelMeanArcWeightProb(   iftImage *grad_test_img, int label,
                                                                iftLabeledSet *seeds,    iftSet *certain_obj_region,
                                                                iftSet *forbidden, iftVector max_disp);
...
iftVector iftMSPSObjModel(   iftImage *grad_test_img, int label,    iftLabeledSet *seeds,
                             iftSet *certain_obj_region,    iftSet *forbidden,
