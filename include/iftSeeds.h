...
* @date     Dec, 2023
*
* @param    bin: a binary image with components near frame 
* @param    frame_dx: distance in voxels along x 
* @param    frame_dy: distance in voxels along y
* @param    frame_dz: distance in voxels along z 
*           (use -1 to avoid elimination in z for 2D and 3D images)
* @return   new binary image without components that are at distance 
*           less than or equal to frame_{dx,dy,dz}  
*/
//! swig(newobject)
