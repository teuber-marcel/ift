...
iftSOSMS *_iftCreateSOSMS(  iftIntArray *labels,   iftImage *template_img,
...
char *_iftWriteSOSMS(  iftSOSMS *sosm_s) {
...
void iftWriteSOSMS(  iftSOSMS *sosm_s, const char *path) {
...
iftSOSMS *iftTrainSOSMS(  iftFileSet *atlas_set,   iftImage *template_img,
                          iftIntArray *labels) {
...
iftImage *iftSegmentBySOSMS(  iftImage *img,   iftImage *grad_img_in,   iftSOSMS *sosm_s) {
...
iftLabeledSet *iftFindSOSMSSeeds(  iftImage *test_img,   iftSOSMSObjModel *obj_model) {
