...
iftAdaPro *_iftCreateAdaPro(  iftIntArray *labels,   iftImage *template_img) {
...
iftImage *_iftAdaProTextureClassification(  iftImage *img,   iftAdaPro *adapro) {
...
/********************** PUBLIC FUNCTIONS *************************/
iftFImage *iftProbAtlasOnTemplateImageDomain(  iftFImage *prob_atlas, iftImageDomain template_shape,
                                             iftVoxel begin) {
...
void iftWriteAdaPro(  iftAdaPro *adapro, const char *format, ...) {
    va_list args;
    char path[IFT_STR_DEFAULT_SIZE];
...
iftAdaPro *iftTrainAdaPro(  iftFileSet *atlas_set,   iftImage *template_img,   iftImage *train_voxels_img,
                            iftIntArray *labels,   iftFloatArray *e_radius_arr,
                            iftFloatArray *d_radius_arr, double C,   iftFileSet *elastix_fset) {
    iftAdaPro *adapro = _iftCreateAdaPro(labels, template_img);
...
iftImage *iftSegmentByAdaPro(  iftImage *img,   iftAdaPro *adapro, const char *aux_basename) {
...
iftFileSet *iftWriteAdaProElastixParamFiles(  iftAdaPro *adapro, const char *basename) {
...
void iftRegisterAdaProOnTestImageByElastix(iftAdaPro *adapro,   iftImage *test_img,   iftFileSet *elastix_files,
...
iftLabeledSet *iftFindObjModelSeeds(  iftObjModel *obj_model,   iftImage *clf_mask, iftSet **forbidden) {
...
void iftSetElastixFilesToAdaPro(iftAdaPro *adapro,   iftFileSet *elastix_fset) {
...
iftImage *iftDilateAdaProRoughSegmentation(  iftAdaPro *adapro) {
