...
def main ():	
	...
	if number_samples_per_class > 100:
		print "WARNING. SOME CLASSES HAVE ONLY 100 IMAGES. SOME CLASSES MY BE UNBALANCED"
	if number_classes > 83:
		print "WARNING: THERE ARE ONLY 83 CLASSES in the face database"
