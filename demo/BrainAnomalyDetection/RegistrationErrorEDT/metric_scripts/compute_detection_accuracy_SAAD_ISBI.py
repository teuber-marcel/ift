...
def main():
    ...
    for detection_img_path in detection_img_pathnames:
        filaname = os.path.basename(detection_img_path)
        gt_path = os.path.join(gt_dir, filaname)
        ...
        detection_data[:, :, mid_sagittal_plane:] = 0
        ...
        for obj in range(1, n_objs + 1):
            ...
            gt_obj_bool_data[:, :, mid_sagittal_plane:] = 0
