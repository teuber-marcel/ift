...
int main(int argc, const char *argv[]) {
    ...
    for (int o = 0; o < labels->n; o++) {
        ...
        lbbs->bbs[o] = iftSimulateUserBoundingBox(umbbs[o], max_disp_mag, scale_factor);

        printf("lbbs->bbs.begin: (%d, %d, %d)\n", lbbs->bbs[o].begin.x, lbbs->bbs[o].begin.y, lbbs->bbs[o].begin.z);
        printf("lbbs->bbs.end: (%d, %d, %d)\n\n", lbbs->bbs[o].end.x, lbbs->bbs[o].end.y, lbbs->bbs[o].end.z);
    }
