 ...
 * @date Sep 18, 2020
 */
iftImage *_iftISFOnRegErrorsSingleObject(  iftImage *reg_errors_mag,   iftMImage *mimg,   iftImage *bin_mask,
...
iftImage *_iftISFOnRegErrorsSingleObjectFast(  iftImage *reg_errors_mag,   iftMImage *mimg,   iftImage *bin_mask,
                                             double alpha, double beta, double thres_factor, double min_dist_to_border,
                                             int n_seeds_on_correct_region) {
    iftIntArray *grid = NULL;
    iftImage *domes = NULL;
...
void iftSingleSupervoxelHistFeats(  iftImage *img,   iftImage *bin_mask,
...
void iftSupervoxelBandHistFeats(  iftMImage *filt_img,   iftImage *svoxels_img,
...
/******************** AutoEncoder ideas ***************************/
iftImage *_iftISFOnAttentionMapSingleObject(  iftImage *atenttion_map,   iftMImage *mimg,   iftImage *bin_mask,
                                            double alpha, double beta, double thres_factor, double min_dist_to_border,
                                            int n_seeds_on_correct_region) {
    iftIntArray *grid = NULL;
    if (min_dist_to_border > 0.0) {
...
void iftSupervoxelBICFeats(  iftImage *img,   iftImage *svoxels_img,
...
void iftSupervoxelLBPFeats(  iftImage *img,   iftImage *svoxels_img, iftDataSet **Zarr,
...
void iftSupervoxelVLBPFeats(  iftImage *img,   iftImage *svoxels_img, iftDataSet **Zarr,
                           int s, int n_bins, int n_supervoxels) {
...
void iftSupervoxelTextureFeats(  iftImage *img,   iftImage *attention_map,
                                 iftImage *svoxels_img, iftDataSet **Zarr,
                               int s, int n_bins, int n_supervoxels) {
