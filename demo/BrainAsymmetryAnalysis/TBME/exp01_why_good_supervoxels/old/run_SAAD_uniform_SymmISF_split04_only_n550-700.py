...
def main():
    ...
    test_set_path = f"sets/ATLAS-304/{split:02d}/test_set_regs.csv"
    ...
    n_svoxels_list = [550, 700]

    out_root_dir = f"exps/01_why_good_supervoxels/split_{split:02d}/uniform_grid_sampling"
