...
*/
void iftWriteSVMModelTrainingParams(FILE *fout,   svmModel *model);

bool iftReadSVMModelTrainingParams(FILE *fin, svmModel *model);

void iftCopySVMModelTrainingParams(svmModel *src, svmModel *dst);

void iftReadSVMInfo(iftSVM *svm,  char *filename);

void iftWriteSVMInfo(  iftSVM *svm,  char *filename);
...
svmProblem *iftDataSetToSVMProblem(iftSVM *svc,   iftDataSet *Z)
{
...
iftSVM* iftCreateSVMFromDict(  iftDict* d) {
...
iftSVM *iftReadSVM( char *pathname) {
    char *path = NULL;
    char *tmp_dir = NULL;
    iftSVM *svm = NULL;
...
void iftWriteSVM(  iftSVM *svm,  char *pathname) {
    char *path = NULL;
    char *tmp_dir = NULL;
...
void iftWriteSVMModelTrainingParams(FILE *fout,   svmModel *model) {/* Training parameters */
...
iftSample iftSVMGetNormalHyperplaneAsSample(  iftSVM *svm, int model_idx,   iftDataSet *Ztrain, float *out_bias) {
    int f, sv;
...
void iftSVMTrainOVO(iftSVM *svm,   iftDataSet *Z, iftDataSet *Zref) {
...
void iftSVMTrainOVA(iftSVM *svm,   iftDataSet *Ztrain, iftDataSet *Zref) {
...
int iftSVMClassifyOVO(  iftSVM *svm, iftDataSet *Z, uchar sample_status) {
...
int iftSVMClassifyOVO_Probability(  iftSVM *svm, iftDataSet *Z, uchar sample_status) {
    int s, nsamples = Z->nsamples;
    int nfeats = Z->nfeats;
...
int iftSVMClassifyOVA(  iftSVM *svm, iftDataSet *Z, uchar sample_status) {
...
int iftSVMLinearClassifyOVA(  iftSVM *svm, iftDataSet *Z, uchar sample_status, iftMatrix **out_pred_mat) {
    int s, f, m;
    int nmodels = svm->nmodels;
