...
iftDataSet *noImpDataset = NULL;
iftDataSet *artificialDataset = NULL;
iftDataSet *validationDataset = NULL;
iftDataSet *poolDataset = NULL;
iftDataSet *testDataset = NULL;
iftMatrix* preprocessing = NULL;
iftMatrix* ldaData = NULL;
...
ObjectDrawingOption currentDrawingNodeOption = NONE;
