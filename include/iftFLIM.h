...
//! swig(destroyer = iftDestroyFLIMArch)
...
/**
* @brief Learns the FLIM layer from a biased perspective,
* it will compute a number of filters per images, combining-it
* the resulting model will be saved into a folder
...
* @param arch            : a given FLIM network architecture.
*/
void iftFLIMLearnBiasedLayer(char *activ_dir, char *markers_dir, char *param_dir, int param_index, iftFLIMArch *arch, char *output_dir);
