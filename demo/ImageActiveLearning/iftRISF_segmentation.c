...
int main(int argc, char* argv[])
{
  ...
  iftISFPathCost pathCost = (iftDictContainKey(PATH_COST_ARG, args, NULL)) ?
    iftGetLongValFromDict(PATH_COST_ARG, args) : 2;
...
#define ALPHA_HELP "Linear weight for parametric distance.\n\
    Smaller is more compact. Recommended range [0.12,0.5] for color\n\
    images and [32,128] for grayscale images, with defaults being\n\
    0.2 and 40.96, respectively."
