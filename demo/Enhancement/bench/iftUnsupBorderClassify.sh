...
#    cmd="iftUnsupBorderClassify smoothed.$extfile $convnet $dirGT$basefile.pgm"; echo -e $cmd; eval $cmd;
    cmd="iftUnsupBorderClassify $dir$line $convnet $dirGT$basefile.pgm"; echo -e $cmd; eval $cmd;
#    cmd="iftUnsupBorderClassify $dir$line $convnet"; echo -e $cmd; eval $cmd;
    cmd="mv basins.thin.pgm $outputdir/$basefile.thin.pgm"; echo -e $cmd; eval $cmd;
done < $fullpath
