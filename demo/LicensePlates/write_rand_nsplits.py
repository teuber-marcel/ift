...
def main():
	...
	parser.add_argument("numFolds", type=int, help="Number of folds")
	...
	for k in range(numFolds):
		...
		outTrainOrigDir = "{}/fold{}/{}/{}".format(outputDir, (k+1), "train", "orig")
		outTrainLabelDir = "{}/fold{}/{}/{}".format(outputDir, (k+1), "train", "label")
		outTestOrigDir = "{}/fold{}/{}/{}".format(outputDir, (k+1), "test", "orig")
		outTestLabelDir = "{}/fold{}/{}/{}".format(outputDir, (k+1), "test", "label")
