 ...
 * @date Sep 16, 2017
 */
iftMImage *iftBuildImageTemplateMImage(   iftImage *img,    iftImage *template_img);
...
void iftSupervoxelHistFeats(   iftImage *img,    iftImage *svoxels_img, iftDataSet **Zarr, int s, int n_bins,
                            int n_supervoxels);
