...
def main():
    if len(sys.argv) != 4:
        sys.exit(f"python {sys.argv[0]} <result_dir> <gt_dir> <out_csv_path>\n"
                 ...
                 "            ...\n\n"
                 "This script ONLY considers overlapping symmetric supervoxels with lesions.\n"
                 "To consider ALL symmetric supervoxels during Dice computation, use the script: symmetrical_dice_all_svoxels.py")
    ...
    for image_key in image_key_list:
        ...
        for obj in range(1, n_objs + 1):
            ...
            print(f"intersection_svoxels_arr={intersection_svoxels_arr}")
