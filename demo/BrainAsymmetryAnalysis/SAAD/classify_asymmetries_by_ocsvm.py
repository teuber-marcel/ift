...
def build_argparse():
    ...
    parser.add_argument('-i', '--symmetric-supervoxels-path', type=str,
                        required=True, help='Supervoxel Image')
    parser.add_argument('-s', '--supervoxels-datasets-entry', type=str, required=True,
                        help='CSV or Directory with the Symmetric Supervoxel Datasets')
    parser.add_argument('-o', '--output-anomalous-supervoxels-img', type=str,
                        required=True, help='Output Image with anomalous symmetric supervoxels')
