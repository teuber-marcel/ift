...
static inline double iftTransformedL2Norm(  double *L,   double *x, int d, int d_out, double *pre_allocated_Lx)
{
    double norm = 0;
...
double *iftScaleDoubleMatrix(  double *data, int n, int d)
{
