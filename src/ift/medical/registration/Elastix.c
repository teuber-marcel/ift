...
/********************** PRIVATE FUNCTIONS *************************/
iftFileSet *_iftAdjustElastixParameterFiles(  iftFileSet *elastix_files,   iftImage *moving_img,
                                              iftImage *fixed_img, const char *tmp_dir) {
...
iftImage *_iftRunElastix(const char *moving_path, const char *fixed_path, const char *moving_mask_path,
                        const char *fixed_mask_path,   iftFileSet *transf_files, const char *out_dir, const char output_file[]) {
    char args[4096];
...
/********************** PUBLIC FUNCTIONS *************************/
iftImage *iftRegisterImageByElastix(  iftImage *moving_img,   iftImage *fixed_img,   iftImage *moving_mask,
                                      iftImage *fixed_mask,   iftFileSet *elastix_files,
...
iftImage *iftRegisterImageByElastixUnstop(  iftImage *moving_img,   iftImage *fixed_img,   iftImage *moving_mask,
                                      iftImage *fixed_mask,   iftFileSet *elastix_files,
                                    const char *def_fields_basename, iftFileSet **def_fields, const char output_file[]) {
...
iftImage *iftTransformImageByTransformix(  iftImage *img, const char *def_fields_path) {
    char args[4096];
    char *tmp_dir = iftMakeTempDir("tmpdir_", NULL, NULL);
...
iftFileSet *iftMoveElastixDefFields(  iftFileSet *def_fields, const char *out_basename) {
    if (def_fields == NULL)
