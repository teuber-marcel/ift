...
if __name__ == '__main__':
    ...
    for i in range(len(model.layers)):
        ...
        # Max pooling layer
        if (isinstance(model.layers[i], keras.layers.MaxPool2D)):
            # Build IFT json data
