...
#include <postprocessing/method/erosion.h>
#include <postprocessing/method/largestcomponentselection.h>
#include <postprocessing/method/loadasmarkers.h>
...
PostProcessing *PostProcessing::instance(QWidget *widget)
{
    if (_instance == nullptr)
        _instance = new PostProcessing(widget);
    return _instance;
}

PostProcessing::PostProcessing(QWidget *widget) :
    QWidget(widget),
...
Method * morphDilationInst() {return new Dilation;}
Method * morphErosionInst() {return new Erosion;}
Method * largestCompInst() {return new LargestComponentSelection;}
Method * loadAsMarkersInst() {return new LoadAsMarkers;}
...
void PostProcessing::addProcessingMethod()
{
    ...
    methods_constructors.insert("Dilation", morphDilationInst);
    methods_constructors.insert("Erosion", morphErosionInst);
    methods_constructors.insert("Select Largest Component", largestCompInst);
    methods_constructors.insert("Load as Markers", loadAsMarkersInst);
    QStringList methods;
